...
function messme(index,panel) {
	...
	return nimi + document.getElementById("numero"+index).value
}
...
(function($) {
	...
	$.anythingSlider.defaults = {
		...
		appendControlsTo    : "#mikon",      // Append controls (navigation + start-stop) to a HTML element (jQuery Object, selector or HTMLNode), if not null
		...
		navigationFormatter : messme,      // Details at the top of the file on this use (advanced use)
